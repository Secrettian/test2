                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;"
                              action="${ctx}/admin/selectTeacher" id="form1" method="post">
                        ...
                        <button class="btn btn-default col-md-2" style="margin-top: 20px"
                                onClick="location.href='${ctx}/admin/addTeacher'">
                            添加教师信息
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-default btn-xs btn-info"
                                        onClick="location.href='${ctx}/admin/editTeacher?id=${item.userid}'">修改
                                </button>
                                <button class="btn btn-default btn-xs btn-danger btn-primary"
                                        onClick="location.href='${ctx}/admin/removeTeacher?id=${item.userid}'">删除
                                </button>
                                <!--弹出框-->
                            </td>
                        </tr>
                        ...
                        <nav style="text-align: center">
                            <ul class="pagination">
                                ...
                                <c:if test="${pagingVO.curentPageNo+1 <= pagingVO.totalCount}">
                                    <li>
                                        <a href="${ctx}/admin/showTeacher?page=${pagingVO.curentPageNo+1}">${pagingVO.curentPageNo+1}</a>
                                    </li>
                                </c:if>
                                <c:if test="${pagingVO.curentPageNo+2 <= pagingVO.totalCount}">
                                    <li>
                                        <a href="${ctx}/admin/showTeacher?page=${pagingVO.curentPageNo+2}">${pagingVO.curentPageNo+2}</a>
                                    </li>
                                </c:if>
                                <c:if test="${pagingVO.curentPageNo+3 <= pagingVO.totalCount}">
                                    <li>
                                        <a href="${ctx}/admin/showTeacher?page=${pagingVO.curentPageNo+3}">${pagingVO.curentPageNo+3}</a>
                                    </li>
                                </c:if>
                                <c:if test="${pagingVO.curentPageNo+4 <= pagingVO.totalCount}">
                                    <li>
                                        <a href="${ctx}/admin/showTeacher?page=${pagingVO.curentPageNo+4}">${pagingVO.curentPageNo+4}</a>
                                    </li>
                                </c:if>
